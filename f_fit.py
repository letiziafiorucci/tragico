...
def model_fit_pseudo2D(path, delays_list, list_path, cal_lim = None, IR=False, VCLIST=None, dofit=True, prev_guess=False, prev_fit=None, file_inp1=None, file_inp2=None, fast=False, limits1 = None, limits2 = None, L1R = None, L2R = None, basl_fit='auto', err_conf=0.95, doexp=False, f_int_fit=None, fargs=None): 
